...
public class Quiz {
 ...
 public static void main(String[] args){
          ...
          //Program Strings
        String Title = "--- Beatles Quiz ---";
        String Question = "what year was john lennon born??";
        String Correct = "That's correct!";
        String TooLow = "That's too low... He died in 1980 in New York City...hint hint!! ";
        String TooHigh = "That's too high! You do know he was the second oldest Beatle right??";
        String TryAgain = "Try Again!";
        String Failure = "The answer is ";
        String Explanation = "October 9th 1940!";
        ...
        //and the user is thanked for playing beatles trivia.
