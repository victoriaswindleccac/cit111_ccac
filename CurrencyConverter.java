...
public static void main (String [] args){
   ...
   int choice = in.nextInt();
    ...
    switch(choice) {
        ...
        case 2: inType = "Euros >>"
                + euro_sym; break; 
        case 3: inType = "British Pounds>>"
                + pound_sym; break; 
        case 4: inType = "Japanese Yen >>"
                + yen_sym; break;  
        default:
